    ...
    <div className="relative min-h-screen pt-32 pb-20 px-6">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="font-cinzel text-5xl text-white tracking-[0.2em] uppercase mb-4">신비로운 상점</h2>
          <p className="font-playfair italic text-xl text-slate-400">"당신의 여정을 풍요롭게 할 영적인 에너지를 보충하세요."</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto mb-20">
          ...
          <div 
            ...
            className="group relative cursor-pointer p-12 border border-[#c58e7133] bg-slate-900/50 hover:border-[#c58e71] transition-all duration-500 overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-30 transition-opacity">
              <Zap className="w-32 h-32 text-[#c58e71]" />
            </div>
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-full border border-[#c58e7133] flex items-center justify-center mb-8 group-hover:border-[#c58e71] transition-colors">
                <Zap className="w-8 h-8 text-[#c58e71]" />
              </div>
              <h3 className="font-cinzel text-3xl text-white tracking-widest mb-4 uppercase">포인트 구매</h3>
              <p className="font-playfair italic text-slate-400 mb-8">즉시 필요한 영적 에너지를 충전하세요.</p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-cinzel text-3xl text-white tracking-widest mb-4 uppercase">월정액 구독</h3>
              <p className="font-playfair italic text-slate-400 mb-8">지속적인 성장을 위한 정기적인 축복을 받으세요.</p>
              <div className="flex items-center gap-4 text-[#c58e71] font-cinzel text-xs tracking-[0.3em] uppercase">
                <span>자세히 보기</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
              </div>
        ...
        <div className="p-10 border border-[#c58e711a] bg-slate-950/50 text-center">
          <h4 className="font-cinzel text-xs text-white tracking-widest uppercase mb-4">상점 안내</h4>
