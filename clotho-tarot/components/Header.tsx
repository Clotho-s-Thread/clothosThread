            ...
            {user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span 
                    className="text-white group-hover:text-[#c58e71] transition-colors hidden sm:block uppercase tracking-widest"
                    style={{ fontSize: '18px' }}
                  >
                    {user.name} 님
                  </span>
                ...
                {isUserMenuOpen && (
                  <div 
                    ...
                    style={{
                      background: 'rgba(22, 25, 47, 0.95)',
                      backdropFilter: 'blur(20px)',
                      WebkitBackdropFilter: 'blur(20px)'
                    }}
                  >
                    <div className="px-6 py-4 border-b border-[#c58e711a] mb-2">
                      <p className="text-[10px] text-slate-600 font-cinzel mb-2 tracking-widest">Consultant</p>
